        ...
        <div class="w-full max-w-5xl bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="flex flex-col md:flex-row">
                ...
                <div class="w-full md:w-1/2 p-8 md:p-12">
                    <div class="mb-8">
                        <h1 class="text-3xl font-bold">Emmas</h1>
                    </div>
                    
                    <div class="mb-8">
                        <h2 class="text-3xl font-bold">Welcome</h2>
                        <h2 class="text-3xl font-bold mb-2">Event Planner!</h2>
                        <p class="text-gray-600">We are glad to see you</p>
                        <p class="text-gray-600">Kindly, enter your details</p>
                    </div>
                    ...
                    <p class="text-center text-gray-600">
                        Already have an account? <a href="${pageContext.request.contextPath}/login" class="text-black hover:underline">Login</a>
                    </p>
                </div>
                        ...
                        <div class="bg-orange-200/50 backdrop-blur-sm rounded-xl p-4 mb-6">
                            <div class="flex items-start">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm">CEO at Emmas Solutions</p>
                                </div>
                            </div>
                        </div>
